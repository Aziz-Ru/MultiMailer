    ...
    <>
      ...
      <div className="md:pl-60 h-screen flex flex-col justify-center items-center">
        ...
        {Select == "Email" ? (
          <>
            <form
              onSubmit={GenerateEmailBYGemini}
              className={`${EmailLoading ? "opacity-20" : ""} w-4/5 lg:w-1/2`}
            >
            ...
            {EmailLoading && (
              <div className=" w-4/5 lg:w-1/2 h-[430px] absolute flex justify-center items-center">
                <svg
                  aria-hidden="true"
          ...
          <>
            <form
              onSubmit={GenerateReportBYGemini}
              className={`${ReportLoading ? "opacity-20" : ""} w-4/5 lg:w-1/2`}
            >
              <div className="mb-3 text-center my-4">
                <h1 className="font-bold text-3xl tracking-wide">
                  Genrate Your Report
            ...
            {ReportLoading && (
              <div className="  w-4/5 lg:w-1/2 h-[400px] absolute flex justify-center items-center">
                <svg
                  aria-hidden="true"
                  className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                  viewBox="0 0 100 101"
